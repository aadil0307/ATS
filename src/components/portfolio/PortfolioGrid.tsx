        ...
        {visible.map((c) => {
          ...
          return (
            <motion.article
              key={c.slug}
              layout={!reduce}
              className="flex flex-col rounded-lg border border-white/10 bg-white/[0.03] p-7 transition-colors hover:border-white/20"
            >
              ...
              <button
                ...
                className="mt-6 inline-flex items-center gap-1 self-start text-sm font-semibold text-blue-bright transition-transform hover:translate-x-1"
              >
